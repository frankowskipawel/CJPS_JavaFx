...
//                    ConfigControllerStage configControllerStage = new ConfigControllerStage();
//                    configControllerStage.start(new Stage());
...
//        Optional<ButtonType> result = DialogsUtils.confirmationDialog("createDatabase.title", "createDatabase.header");
//        if (result.get() == ButtonType.OK) {
            Class.forName("com.mysql.jdbc.Driver");
