...
public class DokumentDao {
    ...
    public Dokument findDokument(String idDokumentu) {
        Dokument dokument = new Dokument("", "", new CertyfikatJakosci("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
        Statement statement = null;
        try {
            statement = connection.createStatement();
            String query = "select * from " + tableName + " WHERE id_dokumenty=" + idDokumentu;
            ResultSet resultSet = statement.executeQuery(query);
            while (resultSet.next()) {
                String id_dokumenty = resultSet.getString("id_dokumenty");
                String data_dokumenty = resultSet.getString("data_dokumenty");
    ...
    public int getNextNumberDokumentDao() {
        Statement statement;
        int autoIncrement = 0;
        int nrNajwyzszy = 0;
        int nrKolejny = 0;
    ...
    public String getAutoIncrementRowLastDokument() {
        Statement statement = null;
        String nrNajwyzszy = "";
        try {
            statement = connection.createStatement();
    ...
    public void deleteLastDokument() {
        ...
        dokumentDao.deleteDokumentDatabase(dokumentDao.getAutoIncrementRowLastDokument());
