...
public class Config {
  ...
  private final String PATH = "config.txt";
    ...
    private void setDefaultConfig() throws IOException {
        ...
        printWriter.println(pl.weglokoks.config.DefaultConnection.CONNECTION.getPort());
        printWriter.println(pl.weglokoks.config.DefaultConnection.CONNECTION.getDatabaseName());
        printWriter.println(pl.weglokoks.config.DefaultConnection.CONNECTION.getUser());
        printWriter.println(pl.weglokoks.config.DefaultConnection.CONNECTION.getPassword());
        printWriter.println("");
        printWriter.println("");
        printWriter.println("");
        printWriter.println("");
